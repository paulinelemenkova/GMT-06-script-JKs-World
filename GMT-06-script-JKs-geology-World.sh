...
gmt pscoast -Rg -JKs180/9i -Gdarkseagreen1 -Slightcyan -W0.25p -Dc \
    ...
    -B+t"Geological features: World map centered on Pacific Ocean" \
    -Bx30g30 -By10g10 \
	-Vv -K > $ps
# Step-2. Add geology
...
gmt psbasemap -R -J \
    ...
    -Lx11.4c/-1.3c+c50+w10000k+l"Scale along equator (km)"+f \
    -UBL/45p/-40p -O -K >> $ps
# Step-4. Add legend
...
5.0 12.0 Eckert VI equal-area pseudocylindrical projection. Central meridian at 180\232
EOF
