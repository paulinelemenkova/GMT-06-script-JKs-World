...
# GMT modules: pscoast, psxy, psbasemap, pslegend, logo, psconvert
# Step-1. Generate file
ps=GMT_geology_World.ps
# Step-2. Plot coastmap
...
# Step-7. Convert to image file using GhostScript (landscape orientation, 720 dpi)
gmt psconvert GMT_geology_World.ps -A0.2c -E720 -Tj -Z
